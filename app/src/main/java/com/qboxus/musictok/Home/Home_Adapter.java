...
import com.qboxus.musictok.Corona.Corona_virus;
...
public class Home_Adapter extends RecyclerView.Adapter<Home_Adapter.CustomViewHolder > {
    ...
    public void onBindViewHolder(final Home_Adapter.CustomViewHolder holder, final int i) {
        ...
        holder.coronadetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cor=new Intent(context, Corona_virus.class);
                context.startActivity(cor);
            }
        });
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView user_pic,sound_image,varified_btn,coronadetails;
        ...
        public CustomViewHolder(View view) {
            super(view);
            coronadetails=view.findViewById(R.id.coronadetails);
