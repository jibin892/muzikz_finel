...
import static com.qboxus.musictok.Main_Menu.MainMenuFragment.hasPermissions;
...
//        builder.show();
    ...
    private void showbotamsheet() {





            final View view = getLayoutInflater().inflate(R.layout.choser_cmra_or_galary, null);
...
//            });
            ...
            (view.findViewById(R.id.cameras)).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(check_permissions())
                        openCameraIntent();
        ...
        (view.findViewById(R.id.galarys)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(check_permissions()) {
                    Intent intent = new Intent(Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
        ...
        (view.findViewById(R.id.cancels)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mBottomSheetDialog.hide();
