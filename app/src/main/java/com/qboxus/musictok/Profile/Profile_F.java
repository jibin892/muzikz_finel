...
import com.qboxus.musictok.Chat.Chat_Activity;
...
ImageView unfollwimg;
TextView unfolloename;
String  name,img;
    ...
    public void Parse_data(String responce){
        ...
        try {
            ...
            if(code.equals("200")){
               ...
               name=(user_info.optString("username"));
               img= Profile_F.pic_url=user_info.optString("profile_pic");
                Picasso.get()
        ...
        Functions.Call_Api_For_Follow_or_unFollow(getActivity(),
                ...
                new API_CallBack() {
                    ...
                    private void shos() {
                        ...
                        dialog.setContentView(R.layout.unfollow);

                           unfollwimg=dialog.findViewById(R.id. unfollwimg);
                          unfolloename=dialog.findViewById(R.id. unfolloename);
                        unfolloename.setText(username2_txt.getText().toString());
                        Picasso.get()
                                .load(img)
                                .placeholder(context.getResources().getDrawable(R.drawable.profile_image_placeholder))
                                .resize(200,200).centerCrop().into(unfollwimg);
                        (dialog.findViewById(R.id.unfolloebtn)).setOnClickListener(new View.OnClickListener() {
                            @Override
...
//                        final View view = getLayoutInflater().inflate(R.layout.botamshetexit, null);
//
                    //    TextView follounfollou=view.findViewById(R.id. follounfollou);
//                        follounfollou.setText("Unfollouw");
//
//
//
//
...
//                        });
    ...
    private void loadshett() {
        ...
        View layout = MainMenuActivity.mainMenuActivity.getLayoutInflater().inflate(R.layout.item_layout_custom_loginmsg,null);
