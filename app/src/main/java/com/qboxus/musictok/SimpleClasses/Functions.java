...
import com.qboxus.musictok.Video_Recording.Post_Video_A;
...
public class Functions {
    ...
    public static void Show_loader(Context context,boolean outside_touch, boolean cancleable) {
        ...
        LoadingDots loader=dialog.findViewById(R.id.loader);
        //loader.start();
    ...
    public static void Show_determinent_loader(Context context, boolean outside_touch, boolean cancleable) {
        ...
        final View view =  LayoutInflater.from(context).inflate(R.layout.block_user,null);
