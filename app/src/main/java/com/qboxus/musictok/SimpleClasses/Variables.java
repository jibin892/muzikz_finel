...
public class Variables {
    ...
    public static final String app_folder=root+"/MUZIKA/";
    ...
    public static String tag="muzika_";
   ...
   public static String gif_api_key1="k3WG4qB69IvkwKAtNFQjSh0R9BMWmSQw";

    public static final String privacy_policy="https://muzikaapp.xyz/terms.html";


     

     public static String base_url="https://muzikaapp.xyz/API/";
