...
import com.qboxus.musictok.SegmentProgress.ProgressBarListener;
import com.qboxus.musictok.SegmentProgress.SegmentedProgressBar;
...
import com.qboxus.musictok.SoundLists.SoundList_Main_A;
import com.qboxus.musictok.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
...
//        });*/
    ...
    public void Start_or_Stop_Recording(){
        ...
        if (!is_recording && sec_passed<(Variables.recording_duration/1000)-1) {
          ...
          //  Toast.makeText(getApplicationContext(), "sdfghfshg", Toast.LENGTH_SHORT).show();
        }
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    private void shoprogress() {
                        ...
                        mBottomSheetDialog1 = new BottomSheetDialog(Video_Recoder_A.this);
    ...
    public void Chnage_Video_size(String src_path,String destination_path){
        ...
        new GPUMp4Composer(src_path, destination_path)
                .size(720, 1280)
                .videoBitrate((int) (0.50 * 32 * 1080 * 1920))
