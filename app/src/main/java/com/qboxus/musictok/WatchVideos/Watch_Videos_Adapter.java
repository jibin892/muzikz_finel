...
public class Watch_Videos_Adapter extends RecyclerView.Adapter<Watch_Videos_Adapter.CustomViewHolder > {
    ...
    public void onBindViewHolder(final Watch_Videos_Adapter.CustomViewHolder holder, final int i) {
        ...
        holder.corona.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent co=new Intent(context, Corona_virus.class);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView user_pic,sound_image,varified_btn,corona;
        ...
        public CustomViewHolder(View view) {
            ...
            corona=view.findViewById(R.id.corona123);
