...
public class Welocom_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pref.getBoolean("activity_executed", false)){
            Intent intent = new Intent(this, Splash_A.class);
    ...
    private void initComponent() {
        ...
        btn_got_it.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent spalsh1=new Intent(getApplicationContext(),Splash_A.class);
                startActivity(spalsh1);            }
        });

        ((Button) findViewById(R.id.btn_skip)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent spalsh=new Intent(getApplicationContext(),Splash_A.class);
    ...
    private void bottomProgressDots(int current_index) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setColorFilter(getResources().getColor(R.color.blue_A700), PorterDuff.Mode.SRC_IN);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.welcomactivitu_wizared, container, false);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Welocom_Activity.this, Splash_A.class));
        finish();
    }
}